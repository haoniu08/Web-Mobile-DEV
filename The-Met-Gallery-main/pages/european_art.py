...
This is the file of the page of European Art.
...
st.header("European Artwork Collection")
...
european_art = EuropeanArt()
european_art.fetch()
list_of_european_art = european_art.ids
...
with c1:
    ...
    start_index = 0
    end_index = 11
    display_art_work_details(start_index, end_index, list_of_european_art)
